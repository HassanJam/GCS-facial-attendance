    ...
    const docDefinition = {
      ...
      styles: {
        header: {
          ...
          bold: true,
          margin: [0, 0, 0, 10],
          color: "#dc3545", // Red color for header text
        },
        tableHeader: {
          bold: true,
          fontSize: 10,
          color: "#fff", // White text for header
          fillColor: "#dc3545", // Red background for header
          alignment: "center",
        },
        tableData: {
          fontSize: 8,
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          <button
            ...
            className="flex items-center space-x-2 bg-red-600 text-white py-2 px-3 rounded-md"
          >
